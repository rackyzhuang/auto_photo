...
- 提供本地人像美化：瘦脸、瘦身、大眼、面部去皱、统一肤色，以及自然的一键美颜组合。
...
移动端界面面向 Android 和 iPhone 的触屏操作，当前只接受 JPG/JPEG 图片。导入照片后，可以在底部工具栏切换 AI、预设、调色、美化、HSL、裁切和增强；人像美化使用随应用打包的本地模型，不会上传照片。右下角提供缩放和眼睛对比按钮，顶部提供返回上一步和导出入口。
